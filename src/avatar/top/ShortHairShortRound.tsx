...
interface ShortHairShortRoundProps {
  children?: ReactNode
}

const ShortHairShortRound: ExtendedComponent<ShortHairShortRoundProps> = ({
  children,
}: ShortHairShortRoundProps) => {
  const filter1 = useId()
  const mask1 = useId()
  const mask2 = useId()
  const path1 = useId()
...
export default ShortHairShortRound
