...
interface ShortHairTheCaesarSidePartProps {
  children?: ReactNode
}

const ShortHairTheCaesarSidePart: ExtendedComponent<
  ShortHairTheCaesarSidePartProps
> = ({ children }: ShortHairTheCaesarSidePartProps) => {
  const reactId = useId()
